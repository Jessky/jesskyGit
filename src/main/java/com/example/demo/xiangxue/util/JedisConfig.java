...
public class JedisConfig extends CachingConfigurerSupport {
    ...
    public  JedisPool redisPoolFactory(){
        ...
        logger.info("maxIdle="+maxIdle+"maxWaitMillis="+maxWaitMillis+"host:"+host+"port"+port+"password"+password);
        ...
        logger.info("redis地址：" + host + ":" + port+"jedisPool"+jedisPool.getResource());
        return  jedisPool;
    }
